...
var NewUserPage = (function () {
    function NewUserPage(navController, fireAuth) {
        this.navController = navController;
        this.fireAuth = fireAuth;
        this.user = new user_1.User('', '');
    }
    NewUserPage.prototype.onClickNewUser = function () {
        var _this = this;
        ...
        this.fireAuth.createUser({ email: this.user.name, password: this.user.password })
            ...
            _this.navController.push(tabs_1.TabsPage, { email: _this.user.name, newUser: true });
        });
    };
